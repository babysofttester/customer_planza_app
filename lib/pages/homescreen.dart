...
class FullHomeContainer extends StatefulWidget {
   final Function(int)? onTabChange; 
  final ServiceItem item;

  const FullHomeContainer({super.key, required this.item, this.onTabChange});

  @override
  State<FullHomeContainer> createState() => _FullHomeContainerState();
}

class _FullHomeContainerState extends State<FullHomeContainer> {
  @override
  Widget build(BuildContext context) {
    return Container( 
      margin: const EdgeInsets.all(5),
